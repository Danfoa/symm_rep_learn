...
gmm_params="symm_group=D6 gmm.n_kernels=30 regular_multiplicity=1 gmm.seed=0 gmm.means_max_norm=1.0 gmm.n_total_samples=20000"
...
python ${exec_file} ${hydra_kwargsDRF} ${exp_params} device=1 model=IDRF train_samples_ratio=0.7,0.18              seed=0,1,2 &
