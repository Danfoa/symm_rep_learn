...
opt_params="batch_size=512 lr=5e-4 max_epochs=7000"
exp_params="exp_label=${exp_label} gmm.n_samples=20000 seed=0,1 truncated_op_bias=full_rank symm_group=C3"
gamma_ncp="gamma=0.1"
